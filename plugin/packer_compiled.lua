...
_G.packer_plugins = {
  ["coc.nvim"] = {
    ...
    loaded = true,
    path = "/Users/x/.local/share/nvim/site/pack/packer/start/coc.nvim",
    url = "https://github.com/neoclide/coc.nvim"
  },
  ["copilot.vim"] = {
    config = { "require('plugs/copilot').setup()" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-lines.lua"] = {
    ...
    loaded = true,
    path = "/Users/x/.local/share/nvim/site/pack/packer/start/nvim-lines.lua",
  ...
  ["vim-floaterm"] = {
    ...
    loaded = true,
    path = "/Users/x/.local/share/nvim/site/pack/packer/start/vim-floaterm",
